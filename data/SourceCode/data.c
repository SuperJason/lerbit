...
#define DEVICE_NAME                          "LerbitData"                               /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME                    "LerbitStudio"                             /**< Manufacturer. Will be passed to Device Information Service. */
...
static void hts_sim_measurement(ble_hts_meas_t * p_meas)
{
    ...
    p_meas->temp_in_celcius.mantissa = 4289;/* celciusX100; */
