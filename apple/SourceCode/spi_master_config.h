...
/*  SPI0 */
#define SPI_PSELSCK0              10   /*!< GPIO pin number for SPI clock (note that setting this to 31 will only work for loopback purposes as it not connected to a pin) */
#define SPI_PSELMOSI0             11   /*!< GPIO pin number for Master Out Slave In    */
#define SPI_PSELMISO0             12   /*!< GPIO pin number for Master In Slave Out    */
#define SPI_PSELSS0               9   /*!< GPIO pin number for Slave Select           */
