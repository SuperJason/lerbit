...
/**@brief Initialize and start the RTC1 counter.
 *
...
/**@brief Returns the current value of the RTC1 counter.
 *
...
/**@brief Computes the difference between two RTC1 counter values.
 *
...
/**@brief Set the RTC1 Capture Compare register 0, and enable the corresponding event.
 *
...
/**@brief Insert timer in timer list.
 *
...
/**@brief Remove timer from timer queue.
 *
...
/**@brief Schedules a check for timeouts by generating a RTC1 interrupt.
 */
...
/**@brief Schedules a timer list update by generating a SWI0 interrupt.
 */
...
/**@brief Execute an application timeout handler, either by calling it directly, or by passing an
...
static void timer_timeouts_check(void)
{
    ...
    if (m_timer_id_head != TIMER_NULL)
    {
        ...
        // Initialise actual elapsed ticks being consumed to 0 
        ticks_expired = 0;
...
/**@brief Acquire the number of ticks elapsed.
 *
 * @param[out] p_ticks_elapsed   Nummber of ticks elapsed.
 *
...
/**@brief Handle timer list deletions.
 *
...
/**@brief Update timer list for expired timers.
 *
...
/**@brief Handle timer list insertions.
 *
...
/**@brief Update Capture Compare register.
 */
...
/**@brief Handle changes to the timer list.
 */
...
/**@brief Allocates a new operations queue entry.
 *
...
/**@brief Schedules a Timer Start operation.
 *
...
/**@brief Schedules a Timer Stop operation.
 *
 * @param[in]  user_id    Id of user calling this function.
...
/**@brief Schedules a Timer Stop All operation.
 *
 * @param[in]  user_id    Id of user calling this function.
 */
 ...
 */
extern void lerbit_rtc1_irq_handler(void);
...
#endif
    lerbit_rtc1_irq_handler();
    // Check for expired timers
    timer_timeouts_check();
}


/**@brief SWI0 interrupt handler.
 *
...
/**@brief Creates a timer user id from the current interrupt level.
 *
