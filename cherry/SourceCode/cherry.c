...
#else
#define DEVICE_NAME                       "CHERRY_2"                                        /**< Name of device. Will be included in the advertising data. */
#endif
...
#else
#define LERBIT_CHERRY_LED_PIN_NO               1
#define LERBIT_CHERRY_BUZZER_PIN_NO            5
#define LERBIT_CHERRY_BUTTON_PIN_NO            4
#endif
...
static void alert_signal(uint8_t alert_level)
{
  switch (alert_level)
  {
    ...
    case BLE_CHAR_ALERT_LEVEL_MILD_ALERT:
      ...
      if (true == m_is_link_loss_alerting) {
#ifdef LERBIT_BUZZER
...
void lerbit_rtc1_irq_handler(void)
{
  ...
  if (NRF_RTC1->EVENTS_COMPARE[3] != 0) {
    ...
    if (lerbit_cherry_led_flash_cnt_temp > 0) {
